...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		_afterZoomIn: function () {
			...
			F.wrap.css('overflow', 'hidden').addClass('fancybox-opened');
			...
			run      = function(e) {
				...
				if (!(e.ctrlKey || e.altKey || e.shiftKey || e.metaKey) && !what.is('.fancybox-wrap')) {
					...
					if (F.open(what, options) !== false) {
						e.preventDefault();
						$("div.fancybox-wrap.fancybox-desktop.fancybox-type-inline.fancybox-opened").css("width", "814px");
						$("div.fancybox-wrap.fancybox-desktop.fancybox-type-inline.fancybox-opened").css("height", "680px");
